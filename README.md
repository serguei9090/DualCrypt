...
> [!NOTE]
> **Production Releases Ready**: Download pre-compiled native installers for Windows, macOS, Linux, and Android from the **[GitHub Releases Page](https://github.com/serguei9090/DualCrypt/releases/tag/v0.5.3)** or try the **[Zero-Knowledge Web Client](https://serguei9090.github.io/DualCrypt/)**.
