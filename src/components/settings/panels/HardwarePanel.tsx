    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <div className="text-xs font-bold text-zinc-100">{t.product_name}</div>
                    {t.serial_number && (
              ...
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-1.5 rounded-lg border border-amber-500/30 bg-amber-500/10 hover:bg-amber-500/20 py-2 text-xs font-semibold text-amber-300 transition-all"
              >
        ...
        {activeChallengeResult && (
          <div className="p-3 rounded-xl bg-zinc-950 border border-amber-500/30 text-xs font-mono text-amber-300 break-all">
            {activeChallengeResult}
          </div>
        )}
      </div>
