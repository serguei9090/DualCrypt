...
def decrypt_file(filepath, password1, password2):
    ...
    try:
        ...
        messagebox.showerror("Error", "Invalid encrypted file format or file not found.")
        return
    ...
    try:
        ...
        messagebox.showerror("Error", "Invalid encrypted file format. Missing required data.")
        return
    ...
    dec_filepath = os.path.splitext(filepath)[0] + "_decrypted"
...
def create_decrypt_gui():
    ...
    pass1 = tk.StringVar()
    ttk.Entry(root, textvariable=pass1, width=30, show="*").pack(pady=5)
    
    ttk.Label(root, text="Password 2:").pack(pady=5)
    pass2 = tk.StringVar()
    ttk.Entry(root, textvariable=pass2, width=30, show="*").pack(pady=5)
