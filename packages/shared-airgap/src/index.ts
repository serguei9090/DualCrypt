/**
 * 📲 DualCrypt Shared Optical Air-Gap Protocol Core
 *
 * Shared zero-dependency protocol for multi-frame animated QR transmission
 * across Desktop, Web, and Android Authenticator applications.
 */

export interface AirGapEnrollmentKey {
...
export type AirGapPayload = AirGapEnrollmentKey | AirGapChallenge | AirGapResponse;

/** Fast 16-bit CRC checksum for frame integrity */
 ...
 */
export function encodePayloadToFrames(payload: AirGapPayload, maxChunkSize = 200): string[] {
 ...
 */
export class AirGapFrameCollector<T = AirGapPayload> {
